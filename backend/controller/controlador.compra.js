...
//finalizar, confirmar
export async function confirmarCompra (req, res, next){
try {
    const {id} = req.params;
...
export async function obtenerHistorialCompras(req, res, next) {
    try {
...
export async function obtenerDetalleCompra(req, res, next) {
    try {
        const { id } = req.params;
